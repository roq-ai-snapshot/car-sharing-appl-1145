  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of transportation with Car Sharing Application - Efficient, economical, and eco-friendly, designed for your convenience."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of transportation with Car Sharing Application - Efficient, economical, and eco-friendly, designed for your convenience.`}
            </Text>
            <Box
